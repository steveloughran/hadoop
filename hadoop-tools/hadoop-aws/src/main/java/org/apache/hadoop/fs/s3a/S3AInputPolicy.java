...
public enum S3AInputPolicy {
  ...
  Normal(FS_OPTION_OPENFILE_READ_POLICY_NORMAL, false, true),
  ...
  public static S3AInputPolicy getPolicy(
    ...
    case FS_OPTION_OPENFILE_READ_POLICY_NORMAL:
      return Normal;

      /* ORC and parquet trigger random IO. */
    ...
    case FS_OPTION_OPENFILE_READ_POLICY_VECTORED:
      return Random;
