...
final class ManifestCommitterConfig {
   ...
   */
  private final Consumer<String> enterStageEventHandler;
  ...
  ManifestCommitterConfig(
      ...
      final Consumer<String> enterStageEventHandler) {
    this.role = role;
    this.jobContext = context;
    this.conf = context.getConfiguration();
    this.destinationDir = outputPath;
    this.iostatistics = iostatistics;
    this.enterStageEventHandler = enterStageEventHandler;
  ...
  StageConfig createJobStageConfig() {
    ...
    stageConfig
        .withEnterStageEventHandler(enterStageEventHandler)
